...
public class LlmScenarioProperties {
  ...
  public static class Scenario {
    ...
    public int getWebSearchMaxKeyword() { return webSearchMaxKeyword; }
    public void setWebSearchMaxKeyword(int webSearchMaxKeyword) { this.webSearchMaxKeyword = webSearchMaxKeyword; }
